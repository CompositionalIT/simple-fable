...
// Simple reference of an module from an NPM package, upper-case
...
console.log (foo "blah de blah") // check the console output...
...
// Alternatively, you can make an interface that maps to the
...
console.log (ucModule.upperCase "hello")
console.log (ucModule.localeUpperCase("hello", "fr"))